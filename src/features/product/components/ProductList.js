...
import { selectProducts, fetchAllProductsAsync } from "../productSlice";
...
const getCategories = (products) => {
  ...
  return [...new Set([...products.map(product=>({value: product.category, label: makeTitleCase(product.category.split('-').join(' ')), checked: false}))])];
}

const getBrands = (products) => {

  return [...new Set([...products.map(product => ({value: product.brand, label: makeTitleCase(product.brand.split('-').join(' ')), checked: false}))])];
}
